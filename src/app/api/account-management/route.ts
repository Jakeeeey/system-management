// src/app/api/account-management/route.ts
...
/**
 * GET: Fetch all users from Directus via the AccountRepo (server-side only path)
 */
...
/**
 * POST: Proxy user management actions (BLOCK, UNBLOCK, FORCE_RESET, etc.)
 */
